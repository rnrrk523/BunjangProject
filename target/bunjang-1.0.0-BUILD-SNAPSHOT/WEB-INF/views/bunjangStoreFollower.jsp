		...
		<div class = "main_area">
			...
			<div>
				<div class = "Store_nav">
					...
					<a class = "Store_nav_category on" href="${pageContext.request.contextPath}/StoreFollower?viewStoreIdx=${viewStoreIdx}">
						팔로워
			...
			<div>
				<div>
					<div class = "Store_product_header">
						<div>
							팔로워
							<span class = "Product_number">${store.followerCount}</span>
						</div>
					</div>
					<c:choose>
					  <c:when test="${store.followerCount == 0}">
						<div class = "Store_product_null">아직 이 상점을 팔로우한 사람이 없습니다.</div>
						<div class = "Store_Follower_main" style = "display:none">
					  </c:when>
					  <c:otherwise>
						<div class = "Store_product_null" style = "display:none">아직 이 상점을 팔로우한 사람이 없습니다.</div>
						<div class = "Store_Follower_main">
					  </c:otherwise>
					</c:choose>
						<div class = "Store_Follower_box">
							<c:forEach var="follower" items="${followerList}">
							   <div class = "Store_Follower_item" data-Sno = "${follower.storeIdx}">
									<div class = "Store_Follower_item_box">
										<a class = "follower_img_box" href="${pageContext.request.contextPath}/StoreProduct?viewStoreIdx=${follower.storeIdx}">
											<div>
												<c:choose>
											      <c:when test="${empty follower.profileImg}">
											        <img
											      ...
											      <c:otherwise>
											        <img src="${follower.profileImg}"
											             width="100" height="100"
											             alt="${follower.storeName} 프로필"
											             class="Store_Profile_img" />
											      </c:otherwise>
											    </c:choose>
											</div>
										</a>
										<a class = "follower_name" href="${pageContext.request.contextPath}/StoreProduct?viewStoreIdx=${follower.storeIdx}">${follower.storeName}</a>
										<div class = "follower_star_box">
											<div class = "follower_star_area">
												<c:forEach var="i" begin="1" end="5">
												    <c:choose>
												        <c:when test="${i <= follower.avgStartIdx}">
												            <img src="${pageContext.request.contextPath}/resources/images/star_on.png" width="15" height="14">
												        </c:when>
												        <c:otherwise>
												            <img src="${pageContext.request.contextPath}/resources/images/star_off.png" width="15" height="14">
										...
										<div class = "follower_productfollower_few">
											<a class ="follower_product_link" href="${pageContext.request.contextPath}/StoreProduct?viewStoreIdx=${follower.storeIdx}">
												상품
												<b>${follower.productCount}</b>
											</a>
											<a class ="follower_follower_link" href="${pageContext.request.contextPath}/StoreFollower?viewStoreIdx=${follower.storeIdx}">
												팔로워
												<b>${follower.followerCount}</b>
											</a>
										</div>
									</div>
								</div>
