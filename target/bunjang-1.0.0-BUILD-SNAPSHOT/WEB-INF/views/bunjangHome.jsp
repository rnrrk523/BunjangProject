	...
	<script>
		$(function() {
			...
			$("#login_and_join").click(function(e) {
				...
				/* window.location.href = "https://kauth.kakao.com/oauth/authorize?client_id=c52a381ffa8c8336a1ea0e22ba6ece9e&redirect_uri=http://localhost:9090/bunjang/kakaoCallback&response_type=code"; */
			})	
			/*로그아웃 버튼 클릭*/
