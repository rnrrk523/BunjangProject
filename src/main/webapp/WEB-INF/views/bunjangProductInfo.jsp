		...
		<div id="center_body">
			<div id="category_channel_div">
				<div id="category_channel_wrap">
					...
					<c:choose>
						<c:when test="${categorylist2Size != 0}">
							...
							<c:choose>
								<c:when test="${categorylist3Size != 0}">
						...
						<div>
							...
							<div style="padding: 0 10px;">
								<div id="store_Info_content_wrap">
									<a href="${pageContext.request.contextPath}/StoreProduct?viewStoreIdx=${productInfo.storeIdx}" id="store_prof_a"><img src="${pageContext.request.contextPath}/resources/images/bunjang_store_prof_nothing.png" width="48" height="48" alt="판매자 프로필 이미지"/></a>
									<div>
										<a href="${pageContext.request.contextPath}/StoreProduct?viewStoreIdx=${productInfo.storeIdx}" id="store_name_a" data-idx="${storeInfo.storeIdx}">${storeInfo.storeName}</a>
										<div style="display: flex;">
											<a href="${pageContext.request.contextPath}/StoreProduct?viewStoreIdx=${productInfo.storeIdx}" class="store_info_a">상품<span id="storeInfo_productCnt_span">${storeInfo.productCnt}</span></a>
											<a href="${pageContext.request.contextPath}/StoreFollower?viewStoreIdx=${productInfo.storeIdx}" class="store_info_a">팔로워<span id="storeInfo_followCnt_span">${storeInfo.followCnt}</span></a>
										</div>
									</div>
								</div>
								<c:choose>
