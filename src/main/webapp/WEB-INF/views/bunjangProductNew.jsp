	...
	<script>
		$(function() {
			...
			$('.categorySelect_bigBtn').click(function () {
			    ...
			    selectedSmall = '';
			    updateCategoryInfo();
			    $("#categorySelect_small").text("소분류 선택");
			    $.ajax({
						...
						<li class="ul1_in_li">
							...
							<div class="second_div">
								<section id="productState_label_wrap">
									<label class="productState_label"><input type="radio" value="새 상품" class="productState_radio_input"/>새 상품 (미사용)<span>사용하지 않은 새 상품</span></label>
									<label class="productState_label"><input type="radio" value="사용감 없음" class="productState_radio_input"/>사용감 없음<span>사용은 사용은 했지만 눈에 띄는 흔적이나 얼룩이 없음</span></label>
									<label class="productState_label"><input type="radio" value="사용감 적음" class="productState_radio_input"/>사용감 적음<span>눈에 띄는 흔적이나 얼룩이 약간 있음</span></label>
									<label class="productState_label"><input type="radio" value="사용감 많음" class="productState_radio_input"/>사용감 많음<span>눈에 띄는 흔적이나 얼룩이 많이 있음</span></label>
									<label class="productState_label"><input type="radio" value="고장/파손 상품" class="productState_radio_input"/>고장/파손 상품<span>기능 이상이나 외관 손상 등으로 수리/수선 필요</span></label>
								</section>
							</div>
						</li>
						<li class="ul1_in_li">
