...
public class StoreDto {
    ...
    public StoreDto(int storeIdx, int visitCount, int sellCount, int avgStartIdx, int productCount, int reviewCount,
			int jjimCount, int followerCount, int followingCount, String storeName, String openDate,
